...
*****************************************
In this particular example the port was done installing
the latest version of the express-session npm  module.
It works but issues deprecation warnings. The next follow up
example will show a version backtracked to an earlier module
version that does not issue deprecation warnings. This is
meant to illustrate the importance of dependency versions
when setting up your apps and package.json files.
********************************************
